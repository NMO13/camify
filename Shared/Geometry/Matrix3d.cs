...
namespace Shared.Geometry
{
    public struct Matrix3d : IEquatable<Matrix3d>
    {
        ...
        public Matrix3d(double[] floatArray)
        {
        ...
        public bool EqualsApprox(ref Matrix3d matrix, float tolerance)
        {
            return
        ...
        /// <param name="tolerance">The limit below which the matrices are considered equal.</param>
        /// <returns>true if the current matrix is approximately equal to the matrix parameter; otherwise, false.</returns>
        public static bool EqualsApprox(ref Matrix3d left, ref Matrix3d right, float tolerance)
        {
            return
        ...
        /// <param name="matrix">The matrix to multiply.</param>
        /// <param name="result">The resulting matrix of the multiplication.</param>
        public void Multiply(float scalar, out Matrix3d result)
        {
        ...
        /// <param name="right">The matrix on the right side of the equation</param>
        /// <param name="result">The resulting matrix of the multiplication.</param>
        public static void Multiply(ref Matrix3d matrix, float scalar, out Matrix3d result)
        {
        ...
        public void Transform(ref Vector3d vector, ref Vector3d result)
        {
        ...
        public static void Transform(ref Matrix3d matrix, ref Vector3d vector, ref Vector3d result)
        {
        ...
        public void Rotate(float angle, out Matrix3d result)
        {
        ...
        public static void Rotate(ref Matrix3d matrix, float angle, out Matrix3d result)
        {
            float angleRadians = MathHelper.DegreesToRadians(angle);
            float sin = (float)System.Math.Sin(angleRadians);
            float cos = (float)System.Math.Cos(angleRadians);
        ...
        public static void RotateMatrix(float angle, out Matrix3d result)
        {
            float angleRadians = MathHelper.DegreesToRadians(angle);
            float sin = (float)System.Math.Sin(angleRadians);
            float cos = (float)System.Math.Cos(angleRadians);
