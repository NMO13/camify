...
namespace Shared.Geometry
{
    ...
    public struct Matrix4d : IEquatable<Matrix4d>
    {
        ...
        /// <returns>A new Matrix4d instance.</returns>
        ...
        {
            Vector3d z = (eye - target).Unit();
            Vector3d x = up.Cross(z).Unit();
            Vector3d y = z.Cross(x).Unit();
        ...
        /// <returns>A new Matrix4d4 which holds the result of the multiplication</returns>
